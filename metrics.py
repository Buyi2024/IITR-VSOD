"""
Evaluation metrics for salient object detection.

Implements the standard metrics used in VSOD evaluation:
- S-measure (Structure-measure)
- maxFm / meanFm (F-measure)
- maxEm / meanEm (Enhanced-alignment Measure)
...
def _prepare_data(pred: np.ndarray, gt: np.ndarray) -> tuple:
    """Normalize prediction to [0, 1] and binarize ground truth."""
    gt = gt > 128
    pred = pred / 255
